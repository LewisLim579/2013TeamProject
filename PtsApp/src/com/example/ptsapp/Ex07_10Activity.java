...
public class Ex07_10Activity extends Activity {
	ListView listView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        c = handler.selectAll();
        int x=1;
        String sql="SELECT * FROM name WHERE week="+x+" AND Day='금요일'";
...
*/
   ...
   switch( item.getItemId() ){
		...
		final	EditText editsets = (EditText)convertView.findViewById(R.id.editsets);
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(Ex07_10Activity.this);
		...
		case R.id.preferMenu:
			Intent intent = new Intent(Ex07_10Activity.this, ShowWeek.class);
			startActivity(intent);
